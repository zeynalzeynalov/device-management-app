...
public class DeviceControllerTest {
    ...
    @Test
    public void getDeviceById_whenNotExists_shouldReturnErrorMessage() throws Exception {
        when(deviceService.getById(1)).thenThrow(new DeviceRepository.DeviceNotFoundException(1));

        mockMvc.perform(MockMvcRequestBuilders.get("/api/devices/v1/1"))
                .andExpect(status().isOk())
                .andExpect(content().contentType(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("status").value("fail"))
                .andExpect(jsonPath("data").value("Device with id=1 not found"));
    }
    ...
    @Test
    public void createDevice_whenSuccessful_shouldReturnSuccess() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/api/devices/v1")
                ...
                .andExpect(jsonPath("data.brand").value(createRequest.getBrand()));
    }
